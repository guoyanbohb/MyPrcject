...
@interface TToEtViewController ()

@end

@implementation TToEtViewController
...
-(void)buttonClick:(UIButton*)button{
    ...
    switch (button.tag) {
        ...
        {
//            NSLog(@"00000000000");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480176828.546682",@"p":@"12-18",@"s":@"4"}];
        }
            break;
        case 301:
        {
//            NSLog(@"111111111111");
            ...
            [center postNotificationName:@"notification1" object:nil userInfo:@{@"shijian":@"480176919.347018",@"p":@"12-18",@"s":@"3"}];
        ...
        {
//            NSLog(@"222222222222");
            [center postNotificationName:@"notification2" object:nil userInfo:@{@"shijian":@"480176936.480865",@"p":@"12-18",@"s":@"2"}];
