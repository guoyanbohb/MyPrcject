...
@interface SmallCarViewController ()

@end

@implementation SmallCarViewController
...
-(void)buttonClick:(UIButton*)button{
    ...
    switch (button.tag) {
        ...
        {
            //            NSLog(@"00000000000");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177065.994323",@"l":@"3",@"s":@"4"}];
        }
            break;
        case 301:
        {
            ...
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177085.797248",@"l":@"3",@"s":@"3"}];
        ...
        {
            //            NSLog(@"222222222222");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177097.514078",@"l":@"3",@"s":@"2"}];
