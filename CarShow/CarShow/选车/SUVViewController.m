...
@interface SUVViewController ()

@end

@implementation SUVViewController
...
-(void)buttonClick:(UIButton*)button{
    ...
    switch (button.tag) {
        ...
        {
            //            NSLog(@"00000000000");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177201.669973",@"l":@"8",@"s":@"4"}];
        }
            break;
        case 301:
        {
            ...
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177222.363936",@"l":@"8",@"s":@"3"}];
        ...
        {
            //            NSLog(@"222222222222");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177233.447443",@"l":@"8",@"s":@"2"}];
