...
@interface MidCarViewController ()

@end

@implementation MidCarViewController
...
-(void)buttonClick:(UIButton*)button{
    ...
    switch (button.tag) {
        ...
        {
            //            NSLog(@"00000000000");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177139.01511",@"l":@"5",@"s":@"4"}];
        }
            break;
        case 301:
        {
            ...
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177153.497297",@"l":@"5",@"s":@"3"}];
        ...
        {
            //            NSLog(@"222222222222");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480177168.247273",@"l":@"5",@"s":@"2"}];
