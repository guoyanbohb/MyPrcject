...
@interface FToEViewController ()

@end

@implementation FToEViewController
...
-(void)buttonClick:(UIButton*)button{
    for (int i=0; i<3; i++) {
        UIButton*temp=(UIButton*)[button.superview viewWithTag:300+i];
    ...
    switch (button.tag) {
        ...
        {
//            NSLog(@"00000000000");
        [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480176673.292734",@"p":@"5-8",@"s":@"4"}];
                    }
            break;
        case 301:
        {
//            NSLog(@"111111111111");
            ...
            [center postNotificationName:@"notification1" object:nil userInfo:@{@"shijian":@"480176715.422476",@"p":@"5-8",@"s":@"3"}];
        ...
        {
//            NSLog(@"222222222222");
            [center postNotificationName:@"notification2" object:nil userInfo:@{@"shijian":@"480176737.730434",@"p":@"5-8",@"s":@"2"}];
