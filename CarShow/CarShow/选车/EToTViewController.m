...
@interface EToTViewController ()

@end

@implementation EToTViewController
...
-(void)buttonClick:(UIButton*)button{
    ...
    switch (button.tag) {
        ...
        {
//            NSLog(@"00000000000");
            [center postNotificationName:@"notification" object:nil userInfo:@{@"shijian":@"480176776.842719",@"p":@"8-12",@"s":@"4"}];
        }
            break;
        case 301:
        {
//            NSLog(@"111111111111");
            ...
            [center postNotificationName:@"notification1" object:nil userInfo:@{@"shijian":@"480176806.346995",@"p":@"8-12",@"s":@"3"}];
        ...
        {
//            NSLog(@"222222222222");
            [center postNotificationName:@"notification2" object:nil userInfo:@{@"shijian":@"480176828.546682",@"p":@"8-12",@"s":@"2"}];
